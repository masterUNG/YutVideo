...
import com.royle.nofix.Mxplayer;
import com.royle.nofix.R;
import com.royle.nofix.SearchActivity;
...
public class TvCategoryActivity extends Activity {
    ...
    public void showContent() {
        ...
        IpTvCategoryAdapter adapter = new IpTvCategoryAdapter(getBaseContext(), R.layout.movie_row, arrData);
                ...
                if (main_id != null) {
                    ...
                    if (true) {
                        ...
                        try {
                            ...
                            FindUrlThread findUrlThread = new FindUrlThread(TvCategoryActivity.this);
    ...
    public void loadData(String main_id) {
        new TvCategoryActivity.DownloadDataTask().execute(main_id);
    }
    ...
    public void checkAcees(String user_id) {
        new TvCategoryActivity.CheckAccessTask().execute(user_id);
    }

...
import static com.royle.nofix.SplashScreen.DIALOG_ERROR_CONNECTION;
...
//                        } else if (playerInstalledOrNot("com.android.gallery3d")) {
        ...
        imbTV2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (dataStore.checkUser()) {
                    intent = new Intent(MainActivity.this, iptv2.IpTvActivity.class);
                    intent.putExtra("id", "2");
                    startActivity(intent);
...
//                String link = "https://play.google.com/store/apps/details?id=com.mxtech.videoplayer.ad";
...
//        btnCode = (Button) findViewById(R.id.btnCode);
        ...
        imbTV2 = (ImageButton) findViewById(R.id.imbTv_main2);
        imbMovie2 = (ImageButton) findViewById(R.id.imbMovie_main2);
        imbSeries2 = (ImageButton) findViewById(R.id.imbSeries_main2);
